defmodule Elaxto.Builder.Scope do

  @stack :elaxto_builder_scopes


  defstruct type: nil, attrs: []

  def open(type, mod, attrs \\ [])  do
    Module.put_attribute(mod, @stack, [%__MODULE__{type: type, attrs: attrs} | on(mod)])
  end
